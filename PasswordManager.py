...
firebaseConfig = {
  "apiKey": "AIzaSyBnP97nSLZhjPsCfwh1CIV3I2fL5KHUpR8",
  "authDomain": "passwordmanager-262c8.firebaseapp.com",
  "projectId": "passwordmanager-262c8",
  "databaseURL":"https://passwordmanager-262c8-default-rtdb.firebaseio.com/",
  "storageBucket": "passwordmanager-262c8.appspot.com",
  "messagingSenderId": "112694559334",
  "appId": "1:112694559334:web:ac693ebba871dfdf93a3a7",
  "measurementId": "G-168G05XEQ3"
}
...
## GUI FOR LOGIN
lgn_layout = [
    [sg.Text("Password Manager\nV1.0", justification='center', size=(25, 2), font=("MontSerrat", 25), relief=sg.RELIEF_RIDGE)],
    [sg.Text("New User?", font=("Ariel", 17))],
...
while True:
    ...
    if evt in "Sign Up":
        if (val['SUemail'] != '' and val['SUpwd'] != '' and val['CNpwd'] != ''):
            ...
            sg.PopupError("Fill all the fields!", title="Error", keep_on_top=True)
    if evt in "Login":
...
layout = [
    [sg.Text("Password Manager\nV1.0", justification='center', size=(25, 2), font=("", 25), relief=sg.RELIEF_RIDGE)],
    [gui_col]]
